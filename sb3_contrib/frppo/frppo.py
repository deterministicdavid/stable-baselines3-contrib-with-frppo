...
class FRPPO(OnPolicyAlgorithm):
    """
    Fisher-Rao Proximal Policy Optimization algorithm (FRPPO) 

    Paper: https://arxiv.org/abs/2506.03757
    Code: This re-uses code from stable baselines PPO (clip) implementation 
    https://github.com/DLR-RM/stable-baselines3/tree/master/stable_baselines3/ppo 
    and replaces the loss function with one based on the Fisher-Rao distance. 
    ...
    :param fr_penalty_tau: Penalty parameter for the Fisher-Rao distance between policy updates,
        it can be a function of the current progress. The smaller the number the bigger the penalty. 
    ...
    def _setup_model(self) -> None:
        ...
        self.fr_penalty_tau = FloatSchedule(self.fr_penalty_tau)
    ...
    def train(self) -> None:
        ...
        fr_penalty_tau = self.fr_penalty_tau(self._current_progress_remaining)  # type: ignore[operator]
        ...
        for epoch in range(self.n_epochs):
            ...
            for rollout_data in self.rollout_buffer.get(self.batch_size):
                ...
                fr2_penalty = (1.0/(8.0*fr_penalty_tau)) * fr2
                ...
                fr2_penalties.append(fr2_penalty.item())
        ...
        self.logger.record("train/fr2_penalties", np.mean(fr2_penalties))
        ...
        self.logger.record("train/fr_penalty_tau", fr_penalty_tau)
        if self.clip_range_vf is not None:
